...
const { getUser, updateUser, updateUserTariff, updateUserBalance, requestPasswordReset, verifyCode, resetPassword, getAllUsersByCurator, getAllUsers, getAllUserWithdrawals, getAllUserDeposits} = require('../controllers/userController');
...
router.put('/update-tariff', updateUserTariff);
